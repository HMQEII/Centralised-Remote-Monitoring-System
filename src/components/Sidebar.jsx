import { Monitor, Users, Key, LogOut, Moon, Sun, Cog, ListVideo } from 'lucide-react'
...
const navItems = [
  ...
  { id: 'device-config', label: 'Device Config', icon: Cog },
]
  ...
  <div className="p-4 border-t border-border dark:border-border-dark">
    <div className="flex items-center justify-between">
      <div>
        ...
        <p className="text-xs text-muted-foreground dark:text-muted-foreground-dark">@UCT</p>
      </div>
